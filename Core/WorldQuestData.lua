-- WorldQuestData.lua  (AUTO-GENERATED by _generator/build-db2-catalog.js -- do not edit by hand)
-- World-quest catalog mined from Blizzard's retail client DB2 (wago.tools):
-- QuestV2CliTask + QuestInfo + ContentTuning + QuestPOIBlob. First-party data;
-- live status is resolved at runtime. Covers the world-quest era (Legion+).
-- Build: 12.0.7.67808
