-- QuestRewards.lua  (AUTO-GENERATED by _generator/build-from-harvest.js -- do not edit by hand)
-- Baked quest titles + rewards + objectives, harvested first-party from the
-- live game client. Loads into DT.BakedDetails; the detail panel reads this
-- when live data isn't cached, so dailies are ready out of the box.
